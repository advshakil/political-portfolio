            ...
            <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">
                        Total {pagination?.total || 0} opinions found
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    <form onSubmit={handleSearch} className="flex gap-2 w-full md:w-auto">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-2 bg-[#006A4E] text-white rounded-lg hover:bg-[#005a42] transition-colors whitespace-nowrap font-medium"
                        >
                            Search
                        </button>
                    </form>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#006A4E] focus:border-[#006A4E] outline-none bg-white text-gray-900"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {opinions.map((opinion) => (
                                    <tr key={opinion._id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4">
                                            <span className="font-medium text-gray-900">
                                                {opinion.name || "Anonymous"}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4">
                                            <p className="text-gray-600 max-w-md line-clamp-2">{opinion.message}</p>
                                        </td>
                                        <td className="px-6 py-4 text-gray-500 font-mono text-sm">
                                            {opinion.ipAddress || "N/A"}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className="p-2 text-[#006A4E] hover:bg-green-50 rounded-lg transition-colors"
                                                    title="View Details"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    disabled={deleting === opinion._id}
                                                    className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50"
                                                    title="Delete"
                                                >
                                                    {deleting === opinion._id ? (
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between px-6 py-4 border-t border-gray-100 gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="px-3 py-1 text-sm rounded-lg hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                First
                            </button>
                            <button
                                ...
                                {Array.from({ length: Math.min(5, pagination.totalPages) }, (_, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-lg text-sm transition-colors ${pageNum === pagination.page
            ...
            {viewingOpinion && (
                <>
                    ...
                    <div
                        ...
                        onClick={() => setViewingOpinion(null)}
                    />
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-end p-6 border-t border-gray-100 bg-gray-50">
                                <button
                                    onClick={() => setViewingOpinion(null)}
                                    className="px-6 py-2 bg-[#006A4E] text-white rounded-lg hover:bg-[#005a42] transition-colors"
                                >
                                    Close
                                </button>
                            </div>
