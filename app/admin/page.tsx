        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-2.5 bg-[#006A4E] text-white rounded-lg hover:bg-[#005a42] transition-all shadow-lg shadow-green-900/10 font-medium"
                >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <Link
                        href="/admin/opinions"
                        className="text-sm text-[#006A4E] hover:underline flex items-center gap-1"
                    >
